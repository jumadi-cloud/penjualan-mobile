	...
	<div class="hk-wrapper hk-vertical-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-dark fixed-top hk-navbar">
            ...
            <a class="navbar-brand" href="dashboard1.html">
                <img class="brand-img d-inline-block" src="{{ asset('assets/assets/media/general/PAR-LOGO-1.png') }}" width="70px" alt="brand" />
            </a>
                ...
                <div class="navbar-nav-wrap">
                    <ul class="navbar-nav flex-column">
                        <li class="nav-item {{ (request()->is(['dashboard*','/'])) ? 'active' : '' }}">
                            <a class="nav-link" href="{{ url('pmp-admin') }}">
                                <span class="feather-icon"><i data-feather="activity"></i></span>
                                <span class="nav-link-text">Dashboard</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('pmp-admin/data-mobil') }}">
                                <span class="feather-icon"><i data-feather="dollar-sign"></i></span>
                                <span class="nav-link-text">Data Mobil</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('pmp-admin/slider-home') }}">
                                <span class="feather-icon"><i data-feather="dollar-sign"></i></span>
                                <span class="nav-link-text">Slider Home</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('pmp-admin/merk-mobil') }}">
                                <span class="feather-icon"><i data-feather="dollar-sign"></i></span>
                                <span class="nav-link-text">Data Merek Mobil</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('pmp-admin/jenis-mobil') }}">
                                <span class="feather-icon"><i data-feather="dollar-sign"></i></span>
                                <span class="nav-link-text">Data Jenis Mobil</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('pmp-admin/setting') }}">
                                <span class="feather-icon"><i data-feather="dollar-sign"></i></span>
