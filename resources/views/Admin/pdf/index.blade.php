            ...
            <div class="x_title">
              ...
              <ul class="nav navbar-right panel_toolbox">
                <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                  ...
                  <div class="x_content">
                    <br />
                    <a href="{{ 'tambah-pdf'}}"><button class="btn btn-primary font-weight-bold">Tambah</button></a>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%" style="margin-top: 2%;">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{ $no_urut++ }}</td>
                          <td><a href="{{ url('storage/data/pdf/'.$pdfs->pdf) }}" target="_blank">{{ $pdfs->pdf }}</a></td>
                          <td>{{ $pdfs->name }}</td>
                          <td>
                            <div class="btn-group">
                              ...
                              <ul role="menu" class="dropdown-menu">
                                ...
                                <li><a href="{{ 'edit-pdf/'.$pdfs->id}}">Edit</a>
                                </li>
                                <li> <a href="{{ 'hapus-pdf/'.$pdfs->id}}" onclick="return confirm_delete()">Hapus</a>
                                </li>
                                {{-- <li class="divider"></li> --}}
                              </ul>
                            </div>
