            ...
            <div class="x_title">
              ...
              <ul class="nav navbar-right panel_toolbox">
                <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                  ...
                  <div class="x_content">
                    <br />
                    <a href="{{ 'tambah-warna'}}"><button class="btn btn-primary font-weight-bold">Tambah</button></a>
                          ...
                          <td>
                            <div class="btn-group">
                              ...
                              <ul role="menu" class="dropdown-menu">
                                ...
                                <li><a href="{{ 'edit-warna/'.$warnas->id }}">Edit</a>
                                </li>
                                <li> <a href="{{ 'hapus-warna/'.$warnas->id }}" onclick="return confirm_delete()">Hapus</a>
                                </li>
                                {{-- <li class="divider"></li> --}}
                              </ul>
                            </div>
